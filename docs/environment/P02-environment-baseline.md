...
Expected result (certified cumulative suite since Package 04, 2026-08-26): **OK (158 tests, 590 assertions)**. (Package 02 closed at 78/371, Package 03 at 118/477; the cumulative suite only grows.)
...
| 9 | `php vendor/bin/phpunit` | `OK (158 tests, 590 assertions)` (cumulative Package 02+03+04 suite; Package 02 closed at 78/371 and Package 03 at 118/477; the earlier 52/229 R3-closure state was never committed and no longer exists) |
