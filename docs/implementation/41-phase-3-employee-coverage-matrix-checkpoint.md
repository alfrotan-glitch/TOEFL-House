...
### COMPLETE (42) — reachable + workflow-proven
...
### MISSING (4 rows remaining) — employee workflows with no transport; ordered fix plan (✅ rows completed and kept for provenance)
