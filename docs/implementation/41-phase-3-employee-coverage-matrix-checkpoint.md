...
### COMPLETE (40) — reachable + workflow-proven
...
### MISSING (6 rows remaining) — employee workflows with no transport; ordered fix plan (✅ rows completed and kept for provenance)
