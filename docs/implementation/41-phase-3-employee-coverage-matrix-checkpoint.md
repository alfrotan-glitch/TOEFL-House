...
### COMPLETE (41) — reachable + workflow-proven
...
### MISSING (5 rows remaining) — employee workflows with no transport; ordered fix plan (✅ rows completed and kept for provenance)
