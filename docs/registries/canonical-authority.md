...
| Role assignment (what a principal holds) | `user_roles` | `server/src/core/rbac/rbac-service.ts` | `server/src/routes/security.routes.ts` | `src/components/security/` | — | `server/src/tests/rbac-single-authority.test.ts` | AUTHORITATIVE |
