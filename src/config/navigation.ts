    ...
    items: [
      {
        ...
        roles: ['owner', 'general_manager', 'finance_manager', 'receptionist', 'teacher', 'head_of_department', 'counselor', 'donor_manager'],
    ...
    items: [
      {
        ...
        icon: 'UserPlus',
        roles: ['owner', 'general_manager', 'receptionist', 'counselor'],
    ...
    items: [
      {
        ...
        label: 'Students',
        icon: 'Users',
        roles: ['owner', 'general_manager', 'finance_manager', 'receptionist', 'teacher', 'head_of_department'],
      ...
      },
      {
        ...
        label: 'Classes',
        icon: 'GraduationCap',
        roles: ['owner', 'general_manager', 'receptionist', 'teacher', 'head_of_department'],
    ...
    items: [
      {
        ...
        label: 'Faculty & Staff',
        icon: 'ClipboardList',
        roles: ['owner', 'general_manager', 'finance_manager', 'head_of_department'],
    ...
    items: [
      {
        ...
        label: 'Finance Desk',
        icon: 'Calculator',
        roles: ['owner', 'general_manager', 'finance_manager'],
      ...
      },
      {
        ...
        label: 'Books & Assets',
        icon: 'BookOpen',
        roles: ['owner', 'general_manager', 'finance_manager', 'receptionist'],
      ...
      },
      {
        ...
        icon: 'HandCoins',
        roles: ['owner', 'general_manager', 'finance_manager', 'donor_manager'],
    ...
    items: [
      {
        ...
        icon: 'BarChart3',
        roles: ['owner', 'general_manager', 'finance_manager', 'receptionist', 'head_of_department'],
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: 'FileText',
        roles: ['owner', 'general_manager', 'head_of_department'],
