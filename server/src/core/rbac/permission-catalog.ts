...
export const PERMISSION_CATALOG: PermissionDef[] = [
  ...
  { code: 'Placement.Override', resource: 'Placement', action: 'Override', description: 'Override completed placement recommendations with an explicit reason and audit trail', category: 'academic' },
...
export const ROLE_DEFINITIONS: RoleDef[] = [
  ...
  },
  {
    ...
    permissions: pick([
      ...
      'Attendance.View','Attendance.Edit','Exam.View','Exam.Create','Exam.Edit','Exam.Publish','Grade.View','Grade.Edit','Placement.Override','Promotion.Approve',
