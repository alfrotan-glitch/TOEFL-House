...
const lines: BudgetLine[] = [
  ...
  line({ id: 'l_it', name: 'Equipment', purpose: 'equipment', categoryId: 'sub_it_equipment', subcategoryId: 'sub_it_equipment', subcategoryName: 'IT Equipment', parentCategoryId: 'cat_capital_expenditure', parentCategoryName: 'Capital Expenditure', classification: 'capital_expenditure', sortOrder: 130 }),
