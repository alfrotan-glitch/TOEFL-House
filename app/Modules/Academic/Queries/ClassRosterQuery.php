...
final class ClassRosterQuery
{
    ...
    public function roster(string $classId): array
    {
        ...
        $seatRows = array_values($seats->map(static fn (Enrollment $enrollment): array => [
        ...
        $teacherRows = array_values($teachers->map(static fn (TeacherAssignment $assignment): array => [
